<template>
  <div class="card3 w-[300px] relative overflow-hidden">
    ...
    <div class="card-content w-full h-full absolute flex flex-col items-center justify-center top-0 left-0 text-white transition-all duration-500 translate-x-[-100%] bg-black">
